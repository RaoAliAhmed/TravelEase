        ...
        <div className="flex flex-wrap items-center gap-2">
          <div className="relative">
            <input
              ...
              className="py-2 pl-10 pr-4 border border-gray-300 text-black rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500"
            />
          ...
          {(type !== 'booking' && type !== 'user' && type !== 'users') && (
            <Link 
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium space-x-2">
                    {type === 'booking' ? (
                      <button
                        ...
                        disabled={isDeleting === item.bookingId}
                        className="text-red-600 hover:text-red-900 disabled:opacity-50"
                      >
                        {isDeleting === item.bookingId ? 'Deleting...' : 'Delete'}
                      </button>
                    ) : (
                      <>
                        <Link 
